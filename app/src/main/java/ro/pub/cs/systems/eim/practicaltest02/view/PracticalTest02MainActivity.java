...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    private TextView pokemonTextView = null;
    ...
    private class GetWeatherForecastButtonClickListener implements Button.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            pokemonTextView.setText(Constants.EMPTY_STRING);

            clientThread = new ClientThread("localhost", Integer.parseInt(clientPort), clientAddress, pokemonTextView, pokemonProfileImageView);
            clientThread.start();
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pokemonTextView = (TextView)findViewById(R.id.weather_forecast_text_view);
    }
